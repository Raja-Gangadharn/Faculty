...
const Sidebar = ({ onLinkClick, isOpen, onClose }) => {
  ...
  return (
    <>
      <div className={`sidebar-overlay ${isOpen ? 'show' : ''}`} onClick={onClose} role="button" aria-label="Close sidebar" tabIndex={isOpen ? 0 : -1} />
      <div 
        className={`faculty-sidebar d-flex flex-column ${isOpen ? 'show' : ''}`}
        aria-hidden={!isOpen}
